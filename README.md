...
3. In **Storyboard · Content**, create or select a Shot, cast Ana, choose her effective **Appearance in this Shot** (Base or any saved Look), choose the Place/background view and write its action and dialogue. Add **This Shot** image or voice overrides only when that Shot must differ from Ana's reusable defaults. Required identity, Look and Place-view files are assigned to numbered H3 outputs automatically.
