...
2. In **Library · Subjects**, create Ana and attach her identity image and default voice. In **Library · Environments**, create any reusable place and attach its background views. **Library · Files** is the compact import and preview shelf for raw images, video and audio.
