...
| `live_action_classic_black_and_white` | classic high-contrast monochrome photography with dense neutral blacks, luminous protected faces, sculptural tonal modeling, differentiated grayscale materials, composed staging and restrained camera operation | an old era, noir plot, detectives, period décor, 4:3 framing, intertitles, sepia, scratches, flicker, projector artifacts, mono audio, hiss, narration, or period music |
...
| `live_action_1980s_television` | polished 1980s television-drama coverage with stable medium-shot geography, measured reactions, motivated settled zooms, warm protected skin, modest analog color separation, readable lifted shadows, gentle optical softness and restrained practical-light bloom | an inferred 1980s setting, period wardrobe or props, sitcom/soap plotting, 4:3 framing, broadcast graphics, VHS damage, scanlines, chroma bleed, tracking errors, canned laughter, announcers, mono audio, synth score, or nostalgia cues |
| `live_action_latin_american_telenovela` | dialogue-led telenovela coverage with lucid two-shots and shot/reverse-shot when cuts are authorized, progressively tighter reactions, motivated settled optical zoom emphasis, luminous skin, open midtones, broadcast-safe color and restrained practical-light bloom | romance, betrayal, secrets, class conflict, tears, shouting, slaps, revelations, Latin American nationality/location, Spanish or Portuguese, accents, extra reactions or cuts, repeated snap zooms, 4:3 framing, broadcast graphics, dramatic stings, recaps, or franchise imitation |
...
| `live_action_classic_western` | classical western-cinema presentation with strong human-to-environment scale, lateral geography, patient masters, economical reactions, protected skin, tactile ochre/sienna/umber materials and clean earth-to-sky separation | a frontier, desert, ranch, saloon, cowboys, outlaws, horses, guns, duels, dust, sunset, period costume, Monument Valley imagery, sepia, film damage, harmonica, guitar, or western plot content |
| `live_action_revisionist_western` | patient unsentimental presentation with measured environmental distance, restrained lens compression, off-center staging, subdued tobacco/umber/olive/stone color, firm readable contrast and unshowy performance | the American West, historical commentary, antiheroes, corruption, frontier hardship, violence, guns, horses, deserts, dust, blood, dirt, fatalism, bleak endings, drones, harmonica, or mournful score |
| `live_action_1950s_studio_color` | premium 1950s studio-color cinema with classical continuity coverage, composed depth, luminous modeled faces, rich dye-transfer-like local color, clean primary separation, gentle optical diffusion, restrained halation and pristine feature polish | an inferred 1950s setting, period costume or décor, glamour, romance, musicals, theatrical dialogue, Academy framing, painted backdrops, orchestral score, mono audio, dubbing, fading, scratches, flicker, or projector artifacts |
...
| `giallo` | 1970s Italian giallo craft: saturated theatrical gel light in red, cobalt, emerald and violet with avowedly artificial motivation, baroque composition through mirrors, glass and stair spirals, slow prowling movement with sudden violent push-ins, glossy lacquer-and-velvet surfaces and exaggerated tactile foley | a killer, stalker, black leather gloves, knives, weapons, victims, stalking, pursuit, murder, violence, blood, bodies, screams, whispers, an Italian setting, a 1970s period, period wardrobe, grime, fog, film grain, print damage, a giallo score, or a mystery plot |
| `tokusatsu_sentai` | 1980s–1990s Japanese henshin-team television craft photographed as live action on broadcast video: frontal held team formations, theatrical choreographed hand-to-hand with exaggerated recoil and stunt rolls, abrupt dramatic zoom-ins, flat high-key video exposure, saturated primary costume color, practical suit and visor material, and quarry or industrial-lot battlegrounds when the location is open | monsters, kaijin, villains, henchmen, giant robots, mecha, transformations, henshin sequences, roll calls, extra team members, explosions, pyrotechnics, fire, smoke, weapons, finishing moves, powers, energy beams, anime or cel rendering, Japanese text, logos, narration, or a franchise team |
| `kaiju_suitmation` | classic suitmation craft on a miniature stage: a suited-performer creature moving with heavy arrested momentum, low street-level viewpoint looking up, layered miniature facades, power lines and vehicles selling scale, hard practical stage light with street-scale searchlights, high-speed-photography debris and water weight, and dry impact foley | a monster, creature, giant animal, destruction, collapsing buildings, fire, smoke, explosions, military response, tanks, jets, evacuation, panicking crowds, victims, radiation, roars, sirens, photoreal CG creature rendering, Japanese text, or a franchise monster |
| `surveillance_found_footage` | raw captured recording from a mounted or body-worn device: continuous unedited runs, wide indifferent slightly distorted framing, available-light exposure limits, flat compressed color, unperformed behavior and thin on-device mono ambience | crimes, intruders, theft, violence, accidents, security staff, watchers, evidence, alarms, jump scares, timestamps, camera identifiers, overlay graphics, recording indicators, night-vision green, infrared, static, dropouts, or degraded audio |
| `home_camcorder_1990s` | consumer camcorder home video with one continuous take, handheld micro-jitter, hunting autofocus and exposure, abrupt motorized zooms, deep small-sensor focus, casual clipped domestic framing, drifting auto white balance and on-camera microphone perspective | birthdays, holidays, weddings, children, pets, family relationships, home-movie occasions, a 1990s setting, period wardrobe, burned-in dates, timecode, recording or battery icons, tracking errors, dropouts, rewind artifacts, tape hiss, nostalgia, or narration |
| `1970s_new_hollywood` | location-shot 35mm American drama with unhurried coverage, longer-lens observation distance, slow motivated zooms, window halation, warm Eastman-style negative color with honest grain, lived-in location texture and overlapping performance-led naturalism | the 1970s, historical events, politics, protest, war, counterculture, drugs, crime, cars, costumes, hairstyles or decor beyond the source, cigarettes, needle-drop songs, score, voice-over, sepia nostalgia, film damage, or a downbeat outcome |
| `silent_era_1920s` | 1920s silent-film craft with centered frontal tableaux, tripod-fixed framing, iris and fade punctuation at existing boundaries, high-contrast monochrome art direction, corner vignetting, accelerated motion cadence and expressive pantomime, with score-forward accompaniment only where the audio policy already allows music | intertitles, title cards, captions, on-screen text, a 1920s setting, period wardrobe, melodrama, villains, pratfalls, silence, muted or filtered speech, hiss, crackle, projector noise, scratches, flicker, gate weave, tinting, sepia, or archival damage |
| `storybook_symmetrical` | planimetric storybook tableaux with one-point frontal or exact profile geometry, axial symmetry, deadpan held framings, right-angled whip pans, even frontal light, flat controlled color fields, meticulous alignment and dry articulated foley | whimsy, quirk, twee props, miniatures, dioramas, chapter titles, captions, readable text, narration, a pastel or any other palette the source does not supply, symmetrical architecture the location lacks, storybook plot beats, or comic music |
...
| `supermarionation` | 1960s marionette-show craft: characters performed as visibly artificial puppets with slightly oversized heads, smooth glossy faces, gentle vertical float and head-tilt performance, meticulously detailed miniature sets with working practical lights, and live-action-style camera staging across miniature space | visible strings, string jokes, puppet gags, rescue missions, emergencies, disasters, countdowns, launches, vehicles, aircraft, rockets, secret bases, uniforms, organizations, a 1960s setting, period props, extra characters, marches, orchestral score, or a franchise design |
| `rotoscope_animation` | animation traced over photographed live action: naturalistic human motion and real weight under a drawn surface, deliberate boiling line, flat or lightly painterly fills sliding against their outlines, graphically simplified backgrounds and the uncanny co-presence of lifelike movement with an obviously drawn image | live action unless explicit, dreams, hallucinations, drug states, psychedelia, morphing, identity shifts, style changes mid-shot, glowing auras, symbolic imagery, medium switches, or a rotoscope post-process filter |
...
| `dieselpunk` | coherent interwar diesel-age vocabulary on existing entities: riveted plate steel, cast housings, stepped art-deco geometry, bakelite and enamel fittings, heavy fabrics and effortful mechanical operation | engines, turbines, aircraft, airships, tanks, factories, refineries, uniforms, militaries, war, propaganda, goggles, smoke, steam, oil spills, or alternate history |
| `nordic_noir` | functional civic and domestic modernity, pale matte materials, thin low-angle daylight, measured spatial distance, careful order and quiet ambience | crime, bodies, victims, police, detectives, investigations, corruption, secrets, Scandinavia, Nordic locations or language, snow, ice, fjords, winter, rain, alcohol, grief, or brooding music |
| `liminal_institutional` | maintained institutional finishing, corridor repetition, even overhead illumination, wayfinding geometry, circulation logic and reverberant building ambience | entities, figures, watchers, monsters, hauntings, backrooms lore, abandonment, ruin, decay, damage, graffiti, flicker, distortion, warped geometry, endless space, time loops, alarms, whispers, or dread music |
...
| `imageTexture` | `none`, `clean_digital`, `subtle_stable_grain`, `film_16mm`, `film_35mm`, `vhs_analog_video`, `early_digital_dv` |
...
prose turns a color grade into invented light sources — colored lights, glow, lamps, neon fixtures, moonbeams,
a visible moon, or emissions absent from the source. Grade vocabulary
itself (`sepia cast`, `green cast`, `pastel wash`, "daylight shadows reading as moonlight") is always accepted,
and so is the palette's own material response (`infrared` foliage rendering red). This checks a specific
